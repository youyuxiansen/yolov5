...
DEST_DIR="YOLOs/shujutang_for_quanzhi_val"
python3 - "$@" <<END
...
src_dir = "VOCs/shujutang_for_quanzhi_val"  # directory structure must the same as VOC
dest_dir = "YOLOs/shujutang_for_quanzhi_val"
classes = ["wire", "shoes", "trashcan", "carpet", "clothes",
