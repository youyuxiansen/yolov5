...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True, inference_type='yolo', model_type='yolo'):
        # Usage:
        #   PyTorch:              weights = *.pt
    ...
    def forward(self, im, augment=False, visualize=False, im_path=''):
